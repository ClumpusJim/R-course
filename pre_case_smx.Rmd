...
Below we make a comparison with results based on Pope Husky's code, just as a double check.
...
If you want to take a look the Vatican code check out the r-scripts in the following directory.

```{r}
dir("/net/hafkaldi/export/u2/reikn/R/SurveyWork/SMB",
    full.names = TRUE)
```

The backbone script is:
```{r}
